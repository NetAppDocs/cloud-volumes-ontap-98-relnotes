...
| Node-based license | 2 PiB (requires separate licenses)
...
| c5, m5, and r5 instances | 21 ^1^ | 336 TiB | 368 TiB | 336 TiB | 2 PiB (requires separate licenses)
|===
...
| c5, m5, and r5 instances | 18 ^1^ | 288 TiB | 368 TiB | 288 TiB | 2 PiB (requires separate licenses)
|===
