---
sidebar: sidebar
permalink: reference-limitations-aws-98.html
...
[.lead]
The following known limitations are specific to Cloud Volumes ONTAP in Amazon Web Services. Be sure to also review link:reference-limitations-98.html[Limitations for Cloud Volumes ONTAP 9.8 in all cloud providers].
...
https://docs.netapp.com/us-en/occm/task_getting_started_aws_c2s.html#limitations[View limitations for Cloud Volumes ONTAP in AWS C2S^].
