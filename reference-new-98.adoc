---
sidebar: sidebar
permalink: reference-new-98.html
...
NOTE: With the addition of this core disk, one less data disk is now supported on systems that use these instance types. link:reference-limits-aws-98.html[Learn more about storage limits in AWS].
...
View link:reference-configs-gcp-98.html[supported configurations] and link:reference-limits-gcp-98.html[storage limits].
...
link:reference-limits-aws-98.html[Learn more about storage VM limits].
...
NOTE: With the addition of this core disk, one less data disk is now supported on single node systems that use these instance types. link:reference-limits-aws-98.html[Learn more about storage limits in AWS].
